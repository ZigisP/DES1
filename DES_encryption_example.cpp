...
// Function that converts binary number in to decimal number
...
int main(){ 
	// A 64 bit key
	string key= "1110101010100001010111010010101001101101001010100110101011111101";
	// A block of plain text of 64 bits
	pt= "0100110101011101000101001111000101010001101010111001011110011100";
	string apt = pt;
